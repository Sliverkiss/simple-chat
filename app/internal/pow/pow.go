// Package pow implements the HashV1 proof-of-work scheme.
//
// HashV1 is SHA3-256 with the Keccak-f[1600] permutation skipping
// round 0 (executing rounds 1..23 only): rate 136 bytes, SHA3 domain padding
// (0x06 ... 0x80 at byte 135), digest = first 32 bytes of state.
package pow

import "encoding/binary"

// roundConstants are the 24 Keccak round constants; index 0 is never used
// because HashV1 skips round 0.
...
// keccakF23 runs rounds 1..23 of Keccak-f[1600] on the state.
...
// HashV1 returns the 32-byte HashV1 digest of data.
func HashV1(data []byte) [32]byte {
	const rate = 136
	var s [25]uint64
